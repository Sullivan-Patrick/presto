        ...
        extends AbstractAnalyzerTest
{
    ...
    private static final String BASE_TABLE_3 = "t2";
    ...
    public void testWithSimpleQuery()
    {
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, originalViewSql);
    }
    ...
    public void testWithDistinct()
    {
        ...
        assertOptimizedQuery(baseQuerySql, baseQuerySql, originalViewSql);
    }
    ...
    public void testWithTableAlias()
    {
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, originalViewSql);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, originalViewSql);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, originalViewSql);
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, originalViewSql);
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, originalViewSql);
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, originalViewSqlWithAliasPartially);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, originalViewSqlWithAliasPartially);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, originalViewSqlWithAliasPartially);
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, originalViewSqlWithAliasPartially);
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, originalViewSqlWithAliasPartially);
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, originalViewSqlWithAliasFully);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, originalViewSqlWithAliasFully);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, originalViewSqlWithAliasFully);
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, originalViewSqlWithAliasFully);
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, originalViewSqlWithAliasFully);
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, originalViewSqlWithTablePrefix);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, originalViewSqlWithTablePrefix);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, originalViewSqlWithTablePrefix);
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, originalViewSqlWithTablePrefix);
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, originalViewSqlWithTablePrefix);
    }
    ...
    public void testAggregationWithTableAlias()
    {
        ...
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, originalViewSql);
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, originalViewSql);
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, originalViewSqlWithAliasPartially1);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, originalViewSqlWithAliasPartially1);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, originalViewSqlWithAliasPartially1);
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, originalViewSqlWithAliasPartially1);
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, originalViewSqlWithAliasPartially1);
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, originalViewSqlWithAliasPartially2);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, originalViewSqlWithAliasPartially2);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, originalViewSqlWithAliasPartially2);
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, originalViewSqlWithAliasPartially2);
        assertOptimizedQuery(baseQuerySqlWithTablePrefix, expectedRewrittenSql, originalViewSqlWithAliasPartially2);
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, originalViewSqlWithAliasFully);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially1, expectedRewrittenSql, originalViewSqlWithAliasFully);
        assertOptimizedQuery(baseQuerySqlWithAliasPartially2, expectedRewrittenSql, originalViewSqlWithAliasFully);
        assertOptimizedQuery(baseQuerySqlFully, expectedRewrittenSql, originalViewSqlWithAliasFully);
    ...
    public void multipleViewsSameBaseTableAllCompatible()
    {
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, viewSql1, viewSql2);
    }
    ...
    public void multipleViewsSameBaseTableNoneCompatible()
    {
        ...
        assertOptimizedQuery(baseQuerySql, baseQuerySql, viewSql1, viewSql2);
    }
    ...
    public void multipleSubqueriesOptimizableFromSameView()
    {
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, viewSql);
    }
    ...
    public void nestedSubqueries()
    {
        ...
        assertOptimizedQuery(baseQuerySql, expectedRewrittenSql, viewSql1, viewSql2, viewSql3);
    }
    ...
    private void assertOptimizedQuery(String baseQuerySql, String expectedQueryAfterOptimization, String... existingViewQueries)
    {
        transaction(transactionManager, accessControl)
                ...
                .execute(CLIENT_SESSION, session -> {
                    ...
                    int i = 1;
                    for (String existingViewQuery : existingViewQueries) {
                        QualifiedObjectName viewTableName = buildQualifiedNameFromViewQuery(session, existingViewQuery);
                        baseTableToMaterializedViewMap.computeIfAbsent(viewTableName, (x) -> new ArrayList<>());
                        baseTableToMaterializedViewMap.get(viewTableName).add(createStubConnectorMaterializedViewDefinition(existingViewQuery, i++));
                    }
    ...
    private QualifiedObjectName buildQualifiedNameFromViewQuery(Session session, String existingViewQuery)
    {
        try {
            Query viewQuery = (Query) SQL_PARSER.createStatement(existingViewQuery, createParsingOptions(session));
            QuerySpecification querySpecification = (QuerySpecification) viewQuery.getQueryBody();
            if (querySpecification.getFrom().get() instanceof Table) {
                Table table = (Table) querySpecification.getFrom().get();
                return createQualifiedObjectName(session, table, table.getName());
            }
            else if (querySpecification.getFrom().get() instanceof AliasedRelation) {
                AliasedRelation aliasedRelation = (AliasedRelation) querySpecification.getFrom().get();
                Table table = (Table) aliasedRelation.getRelation();
                return createQualifiedObjectName(session, table, table.getName());
            }
            else {
                // if we are not working with a query of a shape defined above, it
                // should fail to optimize before we require the QualifiedObjectName
                return QualifiedObjectName.valueOf("foo.bar.baz");
            }
        }
        catch (ClassCastException e) {
            //todo: see if we're using this in any unit test- probably for queries which are not directly joins
            return QualifiedObjectName.valueOf("foo.bar.baz");
        }
    }

    private ConnectorMaterializedViewDefinition createStubConnectorMaterializedViewDefinition(String viewSql, int viewCount)
    {
