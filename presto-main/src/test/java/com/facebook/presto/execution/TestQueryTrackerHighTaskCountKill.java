...
import static com.facebook.presto.spi.StandardErrorCode.CLUSTER_TASK_COUNT_TOO_HIGH;
...
public class TestQueryTrackerHighTaskCountKill
{
    ...
    public void testMultipleQueriesKilledDueToTaskCount()
    {
        ...
        try {
            ...
            assertEquals(((PrestoException) failureReason1).getErrorCode(), CLUSTER_TASK_COUNT_TOO_HIGH.toErrorCode());
            ...
            assertEquals(((PrestoException) failureReason2).getErrorCode(), CLUSTER_TASK_COUNT_TOO_HIGH.toErrorCode());
        }
        finally {
    ...
    public void testLargeQueryKilledDueToTaskCount_withClusterQueryTracker()
    {
        ...
        try {
            ...
            assertEquals(((PrestoException) failureReason).getErrorCode(), CLUSTER_TASK_COUNT_TOO_HIGH.toErrorCode());
        }
        finally {
            scheduledExecutorService.shutdownNow();
        }
